...
class Settings(BaseSettings):
    ...
    narration_tts_provider: str = Field(default="openai", validation_alias="NARRATION_TTS_PROVIDER")
    narration_openai_voice: str = Field(default="coral", validation_alias="NARRATION_OPENAI_VOICE")
    narration_custom_voice_id: str = Field(default="", validation_alias="NARRATION_CUSTOM_VOICE_ID")
    narration_doubao_voice_type: str = Field(default="", validation_alias="NARRATION_DOUBAO_VOICE_TYPE")
